...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../.nodebrew/node/v9.11.2/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{}],"../../.nodebrew/node/v9.11.2/lib/node_modules/parcel-bundler/src/builtins/css-loader.js":[function(require,module,exports) {
...
},{"./bundle-url":"../../.nodebrew/node/v9.11.2/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"css/style.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../.nodebrew/node/v9.11.2/lib/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/Main.elm":[function(require,module,exports) {
(function(scope){
'use strict';
...
var author$project$Main$entryDecoder = A4(
...
var author$project$Main$switchJsonDecoder = A2(
	elm$json$Json$Decode$at,
	_List_fromArray(
		['feed', 'entry']),
	elm$json$Json$Decode$list(author$project$Main$entryDecoder));
var author$project$Main$urlOfSwitchesSpreadsheetJson = 'https://spreadsheets.google.com/feeds/cells/1G0grm4xDFYO-9X4sWX7A8I2V7ag2H9fG2zTa2dnkgow/od6/public/values?alt=json';
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{count: 0, hitCount: 0, key: '', modifier: '', status: author$project$Main$Loading},
		elm$http$Http$get(
			{
				expect: A2(elm$http$Http$expectJson, author$project$Main$GotResponse, author$project$Main$switchJsonDecoder),
				url: author$project$Main$urlOfSwitchesSpreadsheetJson
			}));
};
	...
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				A2(elm$json$Json$Decode$map, author$project$Main$Input, author$project$Main$keyDecoder))
			]));
};
var author$project$Main$Tester = function (a) {
	return {$: 'Tester', a: a};
};
var author$project$Main$claerInterval = 20;
var author$project$Main$KeyMapping = F7(
	function (key, _switch, image, switchType, price, attr, row) {
		return {attr: attr, image: image, key: key, price: price, row: row, _switch: _switch, switchType: switchType};
	});
...
var author$project$Main$toKeyMappings = function (cells) {
	var grouped = A2(
		...
		cells);
	var headers = elm$core$Dict$fromList(
		A2(
			elm$core$List$map,
			function (c) {
				return _Utils_Tuple2(c.col, c.value);
			},
			A2(
				elm$core$Maybe$withDefault,
				_List_Nil,
				A2(elm$core$Dict$get, '1', grouped))));
	var rowToRecord = function (cols) {
		var rowToRecord_ = F2(
			function (cols_, record) {
				rowToRecord_:
				while (true) {
					if (cols_.b) {
						var col = cols_.a;
									...
									record,
									{
										attr: A3(
											...
											A2(
												elm$core$Maybe$withDefault,
												'',
												A2(elm$core$Dict$get, col.col, headers)),
											col.value,
											record.attr)
									});
								cols_ = $temp$cols_;
		...
		return A2(
			rowToRecord_,
			cols,
			A7(author$project$Main$KeyMapping, '', '', '', '', '', elm$core$Dict$empty, 0));
	};
	var rows = elm$core$Dict$values(grouped);
	return A2(
		elm$core$List$filter,
		function (r) {
			return !elm$core$String$isEmpty(r._switch);
		},
		A2(elm$core$List$map, rowToRecord, rows));
};
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								status: author$project$Main$Tester(
									author$project$Main$toKeyMappings(cells))
							}),
						elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
			...
			case 'Tick':
				return (_Utils_cmp(model.count, author$project$Main$claerInterval) > -1) ? _Utils_Tuple2(
					_Utils_update(
						model,
			...
			default:
				if (msg.a.$ === 'Character') {
					...
					return _Utils_eq(
						model.key,
						elm$core$String$fromChar(c)) ? _Utils_Tuple2(
						_Utils_update(
							model,
							{count: 0, hitCount: model.hitCount + 1}),
						elm$core$Platform$Cmd$none) : _Utils_Tuple2(
						_Utils_update(
							model,
							{
								count: 0,
								hitCount: 1,
								key: elm$core$String$fromChar(c)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					var s = msg.a.a;
...
var author$project$Main$viewDebugInfo = function (model) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(model.modifier)
					]))
			]));
};
...
var author$project$Main$switchOf = function (model) {
	...
	if (_n0.$ === 'Tester') {
		...
		return elm$core$List$head(
			A2(
				elm$core$List$filter,
				function (k) {
					return _Utils_eq(k.key, model.key);
				},
				mappings));
	} else {
		return elm$core$Maybe$Nothing;
...
var author$project$Main$viewDefault = A2(
	elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$html$Html$text('スイッチを押してね！')
				]))
		]));
var author$project$Main$orderOfAttr = elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2('コメント', 1),
			_Utils_Tuple2('タイプ', 2),
			_Utils_Tuple2('ストローク（mm）', 3),
			_Utils_Tuple2('接点までの距離（mm）', 4),
			_Utils_Tuple2('Actuation Force (gf)', 5),
			_Utils_Tuple2('Tactile Force (gf)', 6),
			_Utils_Tuple2('Bottom Out (gf)', 7)
		]));
...
var author$project$Main$filterSortAttr = function (a) {
	return A2(
		...
		function (_n1) {
			...
			return A2(
				elm$core$Maybe$withDefault,
				999,
				A2(elm$core$Dict$get, k, author$project$Main$orderOfAttr));
		},
		A2(
			elm$core$List$filter,
			function (_n0) {
				var k = _n0.a;
				return A2(elm$core$Dict$member, k, author$project$Main$orderOfAttr);
			},
			elm$core$Dict$toList(a)));
};
var author$project$Main$viewSwitchAttr = function (m) {
	return elm$core$List$concat(
		A2(
			elm$core$List$map,
			function (_n0) {
				...
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text(k + (': ' + v))
							]))
					]);
			},
			author$project$Main$filterSortAttr(m.attr)));
};
var elm$html$Html$dl = _VirtualDom_node('dl');
var elm$html$Html$h2 = _VirtualDom_node('h2');
var elm$html$Html$h3 = _VirtualDom_node('h3');
var author$project$Main$viewSwitch = function (model) {
	var _switch = author$project$Main$switchOf(model);
	if (_switch.$ === 'Nothing') {
		return author$project$Main$viewDefault;
	} else {
		var m = _switch.a;
		return A2(
			elm$html$Html$dl,
					...
					[
						...
						[
							...
							_List_fromArray(
								[
									elm$html$Html$text(
									'押した回数: ' + elm$core$String$fromInt(model.hitCount))
								]))
						]),
						author$project$Main$viewSwitchAttr(m)
					])));
	}
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				author$project$Main$viewDebugInfo(model)
			]));
};
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Main.Cell":{"args":[],"type":"{ row : String.String, col : String.String, value : String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"Tick":["Time.Posix"],"Input":["Main.Key"],"GotResponse":["Result.Result Http.Error (List.List Main.Cell)"]}},"Main.Key":{"args":[],"tags":{"Character":["Char.Char"],"Control":["String.String"]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Char.Char":{"args":[],"tags":{"Char":[]}}}}})}});
...
},{"../css/style.css":"css/style.css","../src/Main.elm":"src/Main.elm"}],"../../.nodebrew/node/v9.11.2/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../.nodebrew/node/v9.11.2/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/index.js"], null)
